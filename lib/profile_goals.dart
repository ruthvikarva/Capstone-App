                ...
                builder: (BuildContext context, AsyncSnapshot snapshot2) {
                  ...
                  if(snapshot2.data==null || snapshot2.data.documents.length==0){
                    ...
                    var documents = snapshot2.data.documents;
                      ...
                      tranfat=documents[0]["transFat"];
                      fat=documents[0]["fat"]-(satfat+tranfat);//section(sodium);
                    return StreamBuilder<DocumentSnapshot>(
                      stream: Firestore.instance.collection("users").document(userID).snapshots(),
                      builder: (BuildContext context, AsyncSnapshot snapshot3){
                        if(snapshot3.hasError){
                                        ...
                                        PieChart(
                                            PieChartData(
                                                ...
                                                sections: [
                                                  ...
                                                  //transfat
                                                  PieChartSectionData(
                                                    color: const Color(0xFFEFD348),
                                                    value: (tranfat)/((calorieGoal*.01)/9),
                                                    title: "${(((tranfat)/((calorieGoal*.01)/9))*100).toStringAsFixed(1)}%",
                                                    radius: 60,
                                                  ),
                                                  PieChartSectionData(
